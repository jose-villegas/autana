...
| [Render-Harness.md](Render-Harness.md) | Rendering real firmware screens on a host: declaring a scene, what its pixels are pinned to, the QEMU backend, and diffing against a device capture. |
