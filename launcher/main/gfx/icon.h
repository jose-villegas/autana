 ...
 * generated by tools/gen/gen_icons.py instantiates a table of.
 *
 * Mirrors gfx_font_t (gfx_font.h): the hand-written struct lives here, once,
 * so more than one generated atlas (gfx/icons_system.h, and an app's own
 * apps/<name>/icons_<name>.h - see docs/tools/Icon-Baker.md's
