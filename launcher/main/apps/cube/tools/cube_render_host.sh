...
#
#   ./launcher/main/apps/cube/tools/cube_render_host.sh [-o <dir>]
#
...
main/ui/ui_scroll.c
main/apps/cube/app_cube.c
main/apps/cube/cube_mode_switch.c
main/apps/cube/ui/cube_hud_screen.c
main/apps/cube/ui/cube_menu_screen.c
components/microui/src/microui.c
main/apps/cube/tools/cube_render_host.c
"
