 ...
 * portable: a whole `#if CONFIG_LAUNCHER_DEVELOPMENT` block compiles out,
 * with no error, on every build variant including the ones meant to carry
 * it. Any file testing CONFIG_LAUNCHER_* includes this instead of leaving
 * that to chance.
 *
