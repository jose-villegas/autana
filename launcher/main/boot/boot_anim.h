 ...
 * tools/gen/gen_zeta_curve.py. Everything here is integer arithmetic with no
 ...
 * tools/gen/gen_boot_anim_timeline.py's validate() now that these timings are
 ...
 * reimplementation. See tools/render/scenes/boot_anim_render_host.c. */
